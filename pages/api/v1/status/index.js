...
async function status(req, res) {
  ...
  const [used_connections] = await database.query({ text: `SELECT COUNT(*)::int AS used_connections FROM pg_stat_activity where datname = $1;`, values: [process.env.POSTGRES_DB] });
